...
public:
  ...
  rtree_mapper(unsigned int root_edge, unsigned int proximal_edge, unsigned int distal_edge,
               double proximal_length, double distal_length, bool left)
   ...
   */
  auto in_rtree(unsigned int branch_id, double distal_length) const {
