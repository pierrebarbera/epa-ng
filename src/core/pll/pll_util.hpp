...
unsigned int utree_query_branches(pll_utree_t const* const node, pll_unode_t** node_list);
...
// general helpers
std::string get_numbered_newick_string(pll_utree_t const* const root, rtree_mapper const& mapper,
                                       size_t precision = 10);
