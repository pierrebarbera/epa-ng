...
public:
  ...
  Placement(const size_t branch_id, const double likelihood, const double pendant_length,
...
public:
  ...
  Slim_Placement(const size_t branch_id, const double likelihood, const double, const double)
      : branch_id_(branch_id), likelihood_(likelihood) {}
