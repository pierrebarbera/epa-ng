...
public:
  ...
  virtual bool valid() const final { return (status_ != token_status::END); }

  virtual void status(const token_status& s) final { status_ = s; }

  virtual token_status status() const final { return status_; }
